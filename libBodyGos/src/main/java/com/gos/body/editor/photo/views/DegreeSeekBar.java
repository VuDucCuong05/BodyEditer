package com.gos.body.editor.photo.views;
...
public class DegreeSeekBar extends View {
    ...
    public DegreeSeekBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mPointCount = 51;
        this.mPointColor = /*ViewCompat.MEASURED_STATE_MASK;*//*Color.WHITE*/context.getColor(R.color.color_text_title_theme);
        this.mTextColor = /*ViewCompat.MEASURED_STATE_MASK;*//*Color.WHITE*/context.getColor(R.color.color_text_title_theme);
        this.mCenterTextColor = /*ViewCompat.MEASURED_STATE_MASK;*//*Color.WHITE*/context.getColor(R.color.color_text_title_theme);
