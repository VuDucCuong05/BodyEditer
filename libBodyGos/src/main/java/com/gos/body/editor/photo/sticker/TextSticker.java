...
public class TextSticker extends Sticker {
    ...
    private String defaultFont = "fonts/00.ttf";
    ...
    public TextSticker(@NonNull Context context2, AddTextProperties addTextProperties2) {
        ...
        String filePath = context2.getFilesDir().toString() + "/PhotoEditor/Fonts/" + addTextProperties2.getFontName();
        File file = new File(filePath);
        try {
            if (file.exists()) {
                textColor2.setTypeface(Typeface.createFromFile(filePath)).setTextAlign(addTextProperties2.getTextAlign()).setTextShare(addTextProperties2.getTextShader()).resizeText();
            } else {
            ...
            e.getMessage();
            textColor2.setTypeface(Typeface.createFromAsset(assets, defaultFont )).setTextAlign(addTextProperties2.getTextAlign()).setTextShare(addTextProperties2.getTextShader()).resizeText();
        }
