...
import com.gos.body.editor.photo.sticker.event.DeleteIconEvent;
import com.gos.body.editor.photo.sticker.event.FlipHorizontallyEvent;
...
public class StickerView extends RelativeLayout {
    ...
    public void saveStickerFix() {
        this.moveMatrix.set(this.handlingSticker.getMatrix());
        this.moveMatrix.postScale(1.0f, 1.0f, getCurrentSticker().getOriginalBitmap().getWidth(), getCurrentSticker().getOriginalBitmap().getWidth());
        this.moveMatrix.postRotate(0.1f, 594.3719f, 311.0625f);
        // this.moveMatrix.postRotate(1.0f, 594.3719f, 311.0625f);
